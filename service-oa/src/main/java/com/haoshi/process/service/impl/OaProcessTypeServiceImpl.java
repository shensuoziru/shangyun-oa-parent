...
import com.haoshi.process.dao.OaProcessTypeDao;
 ...
 */
@Service
public class OaProcessTypeServiceImpl extends ServiceImpl<OaProcessTypeDao, ProcessType> implements OaProcessTypeService {
